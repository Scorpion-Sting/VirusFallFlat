      ...
      <div class="sidebar-left-content nano-content">
        ...
        <ul class="nav sidebar-menu">
          ...
          <li>
            ...
            <ul class="nav sub-nav">
              <li>
                <a href="<?php echo Url::to(['site/student1']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 学生小甲</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['site/student2']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 学生小乙</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['site/student3']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 学生小丙</a>
              </li>
              <li>
                <a href="<?php echo Url::to(['site/student4']) ?>">
                  <span class="glyphicon glyphicon-book"></span> 学生小丁</a>
              </li>
            </ul>
          </li>
        </ul>
