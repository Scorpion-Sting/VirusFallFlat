...
--
-- 转存表中的数据 `article_title`
--

INSERT INTO `article_title` (`tid`, `title`) VALUES
(1, 'afdsadf');
...
--
-- Indexes for table `article_title`
--
ALTER TABLE `article_title`
 ADD PRIMARY KEY (`tid`);
...
--
-- AUTO_INCREMENT for table `article_title`
--
ALTER TABLE `article_title`
